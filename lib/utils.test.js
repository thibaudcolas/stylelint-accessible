...
/**
 * Wrapper so we can reuse validateOptions’ test suite.
 */
const validateOptions = (result, ruleName, ...optionDescriptions) => {
	return valid(
		result,
		ruleName,
		{ options: optionDescriptions },
		...optionDescriptions.map((o) => o.actual),
	);
};

describe('valid', () => {
	// Copy-paste of https://github.com/stylelint/stylelint/blob/e56af51dd227bd7223b376ddbfbf9501c9d2d89c/lib/utils/__tests__/validateOptions.test.js.
	function mockResult() {
		return { warn: jest.fn() };
	}
